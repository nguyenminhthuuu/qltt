        ...
        <header class="site-navbar py-4 js-sticky-header site-navbar-target" role="banner">
            ...
            <div class="container-fluid">
                <div class="d-flex align-items-center">
                    <div class="site-logo mr-auto w-25"><a href="index.php">L.I.T Center</a></div>
                    ...
                    <div class="mx-auto text-center">
                        <nav class="site-navigation position-relative text-right" role="navigation">
                            <ul class="site-menu main-menu js-clone-nav mx-auto d-none d-lg-block  m-0 p-0">
                                ...
                                <li><a href="#programs-section" class="nav-link">Chương trình</a></li>
                    ...
                    <div class="ml-auto w-25">
                        <nav class="site-navigation position-relative text-right" role="navigation">
                            <ul
                                ...
                                <li class="cta"><a href="admin/index.php" class="nav-link"><span>Đăng nhập</span></a>
                                </li>
                            </ul>
                        </nav>
                        <a href="#"
                        ...
                        <div class="col-12">
                            <div class="row align-items-center">
                                <div class="col-lg-6 mb-4">
                                    <h1 data-aos="fade-up" data-aos-delay="100">Bước đầu đi đến thành công!</h1>
                                    <p class="mb-4" data-aos="fade-up" data-aos-delay="200">Education is the most
                                        powerful weapon we use to change the world.</p>
            ...
            <div class="container">
                ...
                <div class="row justify-content-center">
                    <div class="col-md-7">
                        ...
                        <p class="mb-5">Để lại một tin nhắn cho chúng tôi.</p>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 ml-auto">
                        ...
                        <ul class="list-unstyled footer-links">
                            ...
                            <li><a href="#">Các lớp đào tạo</a></li>
